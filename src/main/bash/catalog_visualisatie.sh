...
sparql --data=../resources/be/vlaanderen/omgeving/data/id/catalog/codelijsten-catalogus/catalog.ttl --query ../sparql/catalog_visualisatie.sparql --results=TURTLE | rdf2dot  | dot -Tpng > ../sparql/catalog_visualisatie.png
pushd  ../../..
git pull
mvn clean install
